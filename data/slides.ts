    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          eyebrow: "Demo time",
          lines: ["Team 1 demo", "Team 2 demo", "Team 3 demo", "Then we vote"],
          kicker: "Five minutes each. Keep it sharp.",
          presenterCue: "Use this as the run-of-show: three team demos, then voting.",
          speakerNotes:
            "Use this slide to sequence the room. Keep each team to five minutes, then move straight into voting.",
        },
        {
          id: "voting",
          kind: "vote",
          ...
          footer: "Pick the strongest overall demo. Once the room is in, we reveal the winner.",
          presenterCue: "Keep voting criteria simple and remind people not to vote for their own team.",
          voting: {
            status: "live-ready",
            prompt: "Vote for the strongest overall project. Do not vote for your own team.",
            options: [
              {
                id: "TEAM1",
                label: "Team 1",
                detail: "First demo team",
              },
              {
                id: "TEAM2",
                label: "Team 2",
                detail: "Second demo team",
              },
              {
                id: "TEAM3",
                label: "Team 3",
                detail: "Third demo team",
              },
            ],
            revealLabel: "Winning team",
          },
        },
      ],
    },
